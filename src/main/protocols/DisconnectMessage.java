...
/**
 * A DisconnectMesaage is sent from a UIController to the Hub when that
 * main.client wants to disconnect.  A DisconnectMessage is also sent from
 * the Hub to each main.client just before it shuts down normally.  DisconnectMessages
