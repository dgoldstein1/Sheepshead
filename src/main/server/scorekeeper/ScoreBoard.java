...
//                obs.log(this.getClass(), LogType.INFO, p.getUsername() + " won this hand for " + hand.getPoints() + " points");
    ...
    private void awardLeasterPoints(int basePoint) {
        ...
        winner.incrGameWon();
//        obs.log(this.getClass(), LogType.INFO, "main.protocols.PlayerData " + winner.getUsername() + " won leaster with " + winner.getPoints() + " points");
        for (Player p : players) {
            if (winner == p) {
...
//            obs.log(this.getClass(), LogType.ERROR, "Size of main.protocols.PlayerData Stats and Categories not equal," +
