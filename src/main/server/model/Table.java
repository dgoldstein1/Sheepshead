...
import main.server.scorekeeper.CardHistory;
...
//        this.obs = obs;
    ...
    public Card[] pickUpBlind(String username) {
        Card[] temp = blind;
        blind = null;
//        .displayMessage(username + " picked up.", "");
        return temp;
    }
...
//            obs.displayMessage("Does not follow suit.\n" + suitLed.name() + " led but " + suitPlayed + " selected.", "");
     ...
     * @returns main.protocols.PlayerData partner if partner is revlealed, null otherwise
     */
